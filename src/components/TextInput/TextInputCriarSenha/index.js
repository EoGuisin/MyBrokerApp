...
class TextInputCriarSenha extends Component {
    constructor(props)
    {
      super(props);
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(TextInputCriarSenha);

TextInputCriarSenha.propTypes = {
...
TextInputCriarSenha.defaultProps = {
  visibilidade: false,
  securetext: true
}