...
class CondicoesTabelaDeVenda extends Component {
  constructor(props)
  {
    super(props);
  }
            ...
            <View 
              ...
              <Text
                style = {{
                  ...
                  textAlign: 'center',
                  color: '#FFFFFF'
              }}>Condição da tabela de vendas</Text>
              <View style = {{width: 40}}/>
            </View>
          </View>
          <ScrollView ref = {(ref) => this.ScrollViewEmpresa = ref}
            ...
            <View 
              ...
              <FlatList
                ...
                data = {this.props.dataCondicoes}
                keyExtractor = {this.props.keyExtractorFlatList}
                renderItem = {this.props.renderCondicoes}
                refreshing = {true}
              />
            </View>
          </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(CondicoesTabelaDeVenda);

CondicoesTabelaDeVenda.propTypes = {
  visibilidade: PropTypes.bool,
  onPressVisibilidade: PropTypes.func,
  renderCondicoes: PropTypes.func,
  dataCondicoes: PropTypes.array,
