...
class RegimeDeBens extends Component {
  constructor(props)
  {
    super(props);
  }
          ...
          <ScrollView ref = {(ref) => this.ScrollViewEmpresa = ref}
            ...
            <View 
              ...
              <FlatList
                ...
                data = {this.props.dataRegimeDeBens}
                keyExtractor = {this.props.keyExtractorFlatList}
                renderItem = {this.props.renderRegimeDeBens}
                refreshing = {true}
              />
            </View>
          </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(RegimeDeBens);

RegimeDeBens.propTypes = {
  visibilidade: PropTypes.bool,
  onPressVisibilidade: PropTypes.func,
  renderRegimeDeBens: PropTypes.func,
  dataRegimeDeBens: PropTypes.array,
