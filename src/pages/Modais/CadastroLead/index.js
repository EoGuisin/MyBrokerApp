...
import { Animated, Modal, View, TouchableOpacity, Text, TextInput, Dimensions, Platform } from 'react-native';
//#endregion
...
class CadastroLead extends Component {
  constructor(props)
  {
    super(props);
  }
...
export default connect(mapStateToProps, mapDispatchToProps)(CadastroLead);

CadastroLead.propTypes = {
  ...
  OptionSelecionada: PropTypes.object
}

CadastroLead.defaultProps = {
