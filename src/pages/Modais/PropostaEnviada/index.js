...
class PropostaEnviada extends Component {
  constructor(props)
  {
    super(props);
  }
         ...
         <View 
          ...
          <View
            ...
            <View
              ...
              <Icon name = {'keyboard-arrow-down'} color = {this.props.StyleGlobal.cores.background} size = {40} style = {{}}
          ...
          <View
            style = {{
              ...
              <View style = {{alignItems: 'center'}}>
                ...
                <Text style = {{marginTop: 24, fontStyle: 'normal', fontWeight: 'bold', fontSize: 24, color: this.props.StyleGlobal.cores.background}}>Proposta enviada!</Text>
                <View style = {{marginHorizontal: 20, marginTop: 35}}>
                  <Text style = {{fontStyle: 'normal', fontWeight: 'bold', fontSize: 16, textAlign: 'center', color: this.props.StyleGlobal.cores.background, lineHeight: 25}}>Sua proposta foi enviada com sucesso e a secretaria de vendas irá conferir as informações e documentos, caso seja aceita seguiremos com a emissão do contrato.</Text>
                </View>
                <View style = {{marginTop: 35}}>
                  <Text style = {{textAlign: 'center', fontStyle: 'normal', fontWeight: 'normal', fontSize: 12, color: '#677367', marginTop: 4}}>Dúvidas</Text>
                  <Text style = {{textAlign: 'center', fontStyle: 'normal', fontWeight: 'normal', fontSize: 12, color: '#677367', marginTop: 4}}>vendas@</Text>
                  <Text style = {{textAlign: 'center', fontStyle: 'normal', fontWeight: 'normal', fontSize: 12, color: '#677367', marginTop: 4}}>(XX) XXXX-XXXX</Text>
                </View>
              </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(PropostaEnviada);

PropostaEnviada.propTypes = {
