...
class Sexualidade extends Component {
  constructor(props)
  {
    super(props);
  }
            ...
            <View 
              ...
              <Text
                style = {{
                  ...
                  textAlign: 'center',
                  color: '#FFFFFF'
              }}>Selecione a sua sexualidade</Text>
              <View style = {{width: 40}}/>
            </View>
            <View
              style = {{
              ...
              <SearchInput
                ...
                placeholder = 'Pesquise aqui pelo sexo...'
          ...
          <ScrollView ref = {(ref) => this.ScrollViewNacionalidade = ref}
            ...
            <View 
              ...
              <FlatList
                ...
                data = {this.props.filteredSexualidade}
                keyExtractor = {this.props.keyExtractorFlatList}
                renderItem = {this.props.renderSexualidade}
                refreshing = {true}
              />
            </View>
          </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Sexualidade);

Sexualidade.propTypes = {
