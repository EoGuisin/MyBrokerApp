          ...
          <ScrollView ref = {(ref) => this.ScrollViewEmpresa = ref}
            ...
            <View 
              ...
              <FlatList
                ...
                data = {this.props.dataCloser}
                keyExtractor = {this.props.keyExtractorFlatList}
                renderItem = {this.props.renderCloser}
                refreshing = {true}
              />
            </View>
          </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Closer);

Closer.propTypes = {
  visibilidade: PropTypes.bool,
  onPressVisibilidade: PropTypes.func,
  renderCloser: PropTypes.func,
  dataCloser: PropTypes.array,
