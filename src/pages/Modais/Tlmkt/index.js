          ...
          <ScrollView ref = {(ref) => this.ScrollViewEmpresa = ref}
            ...
            <View 
              ...
              <FlatList
                ...
                data = {this.props.dataTlmkt}
                keyExtractor = {this.props.keyExtractorFlatList}
                renderItem = {this.props.renderTlmkt}
                refreshing = {true}
              />
            </View>
          </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(Tlmkt);
