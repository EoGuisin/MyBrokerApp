...
class FinalidadesDeCompra extends Component {
  constructor(props)
  {
    super(props);
  }
          ...
          <ScrollView ref = {(ref) => this.ScrollViewEmpresa = ref}
            ...
            <View 
              ...
              <FlatList
                ...
                data = {this.props.dataFinalidades}
                keyExtractor = {this.props.keyExtractorFlatList}
                renderItem = {this.props.renderFinalidades}
                refreshing = {true}
              />
            </View>
          </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(FinalidadesDeCompra);

FinalidadesDeCompra.propTypes = {
  visibilidade: PropTypes.bool,
  onPressVisibilidade: PropTypes.func,
  renderLiner: PropTypes.func,
  dataLiner: PropTypes.array,
