...
class SubGerenteSala extends Component {
  constructor(props)
  {
    super(props);
  }
          ...
          <ScrollView ref = {(ref) => this.ScrollViewEmpresa = ref}
            ...
            <View 
              ...
              <FlatList
                ...
                data = {this.props.dataSubGerenteSala}
                keyExtractor = {this.props.keyExtractorFlatList}
                renderItem = {this.props.renderSubGerenteSala}
                refreshing = {true}
              />
            </View>
          </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(SubGerenteSala);

SubGerenteSala.propTypes = {
  visibilidade: PropTypes.bool,
  onPressVisibilidade: PropTypes.func,
  renderSubGerenteSala: PropTypes.func,
  dataSubGerenteSala: PropTypes.array,
