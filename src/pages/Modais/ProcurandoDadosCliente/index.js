...
class ProcurandoDadosCliente extends Component {
  constructor(props)
  {
    super(props);
  }
      ...
      <Modal
        ...
        <View style = {{flex: 1, backgroundColor: '#FFFFFF'}}>
          ...
          <View 
            ...
            <Lottie 
              resizeMode = 'contain' 
              source = {EfeitoProcurandoCliente}
              autoPlay
            />
          </View>
        </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(ProcurandoDadosCliente);

ProcurandoDadosCliente.propTypes = {
