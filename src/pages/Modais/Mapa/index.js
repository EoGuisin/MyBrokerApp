    ...
    return(
      <Modal 
        ...
        <View style = {{flex: 1, backgroundColor: '#E6E6E6'}}>
          <View>
            <Icon style = {{marginLeft: 30, marginTop: 40}} name = 'close' size = {40} color = {'rgba(0, 0, 0, 0.5)'}
              onPress = {async () => {this.props.onPress}}/>
          </View>
          <View style = {{ flex: 1, marginTop: 22 }}>
          <Lottie resizeMode = 'cover' source = {EfeitoMapa} autoPlay/>
          </View>
        </View>
      </Modal>
    );
