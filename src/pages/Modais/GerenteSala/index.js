...
class GerenteSala extends Component {
  constructor(props)
  {
    super(props);
  }
          ...
          <ScrollView ref = {(ref) => this.ScrollViewEmpresa = ref}
            ...
            <View 
              ...
              <FlatList
                ...
                data = {this.props.dataGerenteSala}
                keyExtractor = {this.props.keyExtractorFlatList}
                renderItem = {this.props.renderGerenteSala}
                refreshing = {true}
              />
            </View>
          </ScrollView>
...
export default connect(mapStateToProps, mapDispatchToProps)(GerenteSala);

GerenteSala.propTypes = {
  visibilidade: PropTypes.bool,
  onPressVisibilidade: PropTypes.func,
  renderGerenteSala: PropTypes.func,
  dataGerenteSala: PropTypes.array,
